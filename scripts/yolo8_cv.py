...
from human_pose_detection.Camera.CvL515Module import CvL515Module
from human_pose_detection.Model.Yolov8Module import Yolov8Module
from human_pose_detection.Visualization.CvVisualizationModule import CvVisualizationModule
...
if __name__ == '__main__':
    ...
    # Create CameraModule
    package_path = rospkg.RosPack().get_path('human_pose_detection')
    
    file_path = package_path + "/desk_standing2"
    camera = CvL515Module(file_path)
    # Create ModelModule
    model = Yolov8Module()
    # Create VisuModule
